    ...
    stages {
        ...
        stage('Deploy to EC2') {
            steps {
                ...
                bat 'ssh -i C:\\Users\\pd550\\Downloads\\ssh-ttodo-key.pem -o StrictHostKeyChecking=no ubuntu@<35.176.246.99> "cd /home/ubuntu/todoapp && nohup dotnet TodoApi.dll > log.txt 2>&1 &"'
            }
        }
    }
}
